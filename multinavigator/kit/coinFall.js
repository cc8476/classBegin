...
import erlich from '../assets/coin.png';
import moneyFront from '../assets/coin.png';
import moneyBack from '../assets/coin.png';
...
const ErlichBachman = ({ children }) => (
  <ImageBackground source={erlich} style={{ flex: 1,zIndex:100 }}>
    {children}
  </ImageBackground>
);

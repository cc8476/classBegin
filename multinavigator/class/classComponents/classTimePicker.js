...
class App extends React.Component {
    ...
    pickupInit() {
        let pickData = [
          ...
          ["10分钟","20分钟","30分钟","40分钟","50分钟","60分钟","70分钟","80分钟","90分钟"],
        ];
    ...
    render() {
        ...
        return (
            ...
            <Icons style={{paddingTop:8}} name="plus-square" size={22}  color="green"
                        onPress={
                            ()=>this.props.add()
                        }
            ></Icons>
        ...
        />
        <Icons style={{paddingTop:8}} name="minus-square" size={22}  color="red"
            onPress={
                ()=>{
